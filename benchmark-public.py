...
REPOS = {
    ...
    "nestjs": {
        ...
        "subpath": "sample",
        "shallow": True,
        "note": "Framework source but sample/ has real NestJS apps with controllers/modules",
    },
    "angular": {
        "remote": "angular/angular",
        "name": "Angular",
        "feature": "Angular framework detection",
        "subpath": "packages/platform-browser",
        "shallow": True,
        "note": "Angular source — platform-browser has components, directives, services",
    },
    "turborepo": {
    ...
    "remix": {
        ...
        "subpath": "packages/remix-dev",
        "shallow": True,
        "note": "Remix source — remix-dev has route patterns and loaders",
    },
    "ai-sdk": {
        "remote": "vercel/ai",
        "name": "AI SDK",
